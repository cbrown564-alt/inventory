...
## §M5b — phone guided capture — REMOVED 4 Jul 2026

> **Archived.** Phone guided capture was tried on a real device and killed.
> The primary capture path is **one walkthrough video uploaded in the
> browser** (docs/12). Full historical record:
> [`archive/09-m5b-guided-capture-retired.md`](archive/09-m5b-guided-capture-retired.md).
