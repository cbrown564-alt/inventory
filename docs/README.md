...
1. [37](37-synthetic-backlog.md) → naming/alignment and cleanliness-gate product decisions from the closed describe and compare checks; do not reopen the Pass B / prompt-tournament arms. *Supersedes docs/36 as the live synthetic next-work pointer.*
