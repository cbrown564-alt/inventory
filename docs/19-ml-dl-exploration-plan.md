...
| **ML-E14** | Compare | Siamese embedding on pairs | — (exploratory) | not started | paired fixture only |
| **ML-E15** | Defect | Anomaly pre-filter zero-shot | FP rate <10% on IFlex | not started | `defect-filter-report.json` |
