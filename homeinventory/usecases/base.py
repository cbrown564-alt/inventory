...
class ComparisonSpec:
    ...
    intro_note: str
    # Rendered as an entry line ("<label>: <age|not provided>") only when set;
    # per-item age is a tenancy concept (residual value) — see _item_ages().
    item_age_label: str | None = None
